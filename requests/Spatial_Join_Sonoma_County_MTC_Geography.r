# Spatial_Join_Sonoma_County_MTC_Geography.r
# Script to join Sonoma County origins and destinations to MTC TAZ 1454 geography
# SI

# Set working directory

wd <- "M:/Data/Requests/Iain Conway/Output Files/"
setwd(wd)
...
Shapefile    <- "M:/Data/GIS layers/Travel_Analysis_Zones_(TAZ1454)/Travel Analysis Zones.shp"
