...
# New Users will need to add themselves to this lookup.
...
survey_standard <- survey_standard %>%
  ...
  select(-language_at_home_binary, -language_at_home_detail, -race_dmy_ind, 
         -race_dmy_asn, -race_dmy_blk, -race_dmy_hwi, -race_dmy_wht, 
         -race_dmy_oth, -race_dmy_sum, -race_other_string
         )
...
save(survey_decomposition, file = f_output_decom_rdata_path)
...
save(survey_standard, file = f_output_rdata_path)
save(ancillary_df, file = f_ancillary_output_rdata_path)
