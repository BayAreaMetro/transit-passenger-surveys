...
survey_standard <- survey_standard %>%
  mutate(first_before_operator = str_extract(first_route_before_survey_board, "^[A-Z ]+"),
         second_before_operator = str_extract(second_route_before_survey_board, "^[A-Z ]+"),
         third_before_operator = str_extract(third_route_before_survey_board, "^[A-Z ]+"),
         first_after_operator = str_extract(first_route_after_survey_alight, "^[A-Z ]+"),
         second_after_operator = str_extract(second_route_after_survey_alight, "^[A-Z ]+"),
         third_after_operator = str_extract(third_route_after_survey_alight, "^[A-Z ]+"))
