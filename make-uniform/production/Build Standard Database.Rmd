...
F_BART_SURVEY = "M:/Data/OnBoard/Data and Reports/BART/As CSV/BART_EditChecks_ALL_BATCHES_COMBINED_July19 NO POUND OR SINGLE QUOTE.csv"
...
# TODO: make sure BART IDs are unique
debug <- survey.BAR %>%
  group_by(ID) %>%
  summarise(count = n())
