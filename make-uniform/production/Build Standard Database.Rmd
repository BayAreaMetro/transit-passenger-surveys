...
source("make-uniform/production/Build Standard Database Functions.R")
...
user_list <- data.frame(
  ...
  path = c("../../Data and Reports/", 
           ...
           "C:/Users/ywang/Box/Mine/Data/OnboardSurvey_chk_202002_yq/Data and Reports/"
           )
)
```
...
dictionary_all <- read.csv('make-uniform/production/Dictionary for Standard Database.csv', 
                           header = TRUE) %>%
  rename_all(tolower)
...
```{r}
rail_names_inputs_df <- read.csv('make-uniform/production/rail_names_inputs.csv')
...
canonical_routes_crosswalk <- read.csv('make-uniform/production/canonical_route_crosswalk.csv')
```
