...
f_rail_names_inputs_path <- "rail_names_inputs_20200210.csv"

f_geocode_column_names_path <- "bespoke_survey_station_column_names.csv"

f_canonical_routes_path <- "canonical_route_crosswalk_20200210.csv"
...
```{r}
rail_names_inputs_df <- read.csv('rail_names_inputs.csv')
