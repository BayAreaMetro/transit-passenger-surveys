...
survey_flat <- bind_rows(survey_cat, survey_non) %>%
  ...
  mutate(route = ifelse(operator == "BART", paste("BART", onoff_enter_station, onoff_exit_station, sep = DELIMITER), route)) %>%
  mutate(route = ifelse(operator == "Caltrain", paste("CALTRAIN", onoff_enter_station, onoff_exit_station, sep = DELIMITER), route)) %>%
