...
survey.standard <- survey.standard %>%
  mutate(number_transfers_orig_board = ifelse(is.na(number_transfers_orig_board), 
                                              !is.na(first_route_before_survey_board) + 
                                                !is.na(second_route_before_survey_board) + 
                                                !is.na(third_route_before_survey_board), 
                                              number_transfers_orig_board)) %>%
  mutate(number_transfers_alight_dest = ifelse(is.na(number_transfers_alight_dest),
                                               !is.na(first_route_after_survey_alight) + 
                                                 !is.na(second_route_after_survey_alight) + 
                                                 !is.na(third_route_after_survey_alight),
