...
```{r methods}
# Set Operator Name
Set_Operator_Name <- function(input_df){
...
table(survey.standard$first_route_before_survey_board)

input_df <- survey.standard %>%
  select(Unique_ID, input_field = first_route_before_survey_board)

first_route_before <- Set_Operator_Name(input_df)

table(first_route_before$output_field)
