...
*          See BuildDatabases.sas for script to create SAS databases.  Specific to Sonoma
*          County transit.
*          Work in progress.
*
* Location: M:\Data\OnBoard\Data and Reports\
*
* Author(s): dto (2013 09 XX)
*
* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
...
%let gis_geocode     = 'M:\Data\OnBoard\Data and Reports\Sonoma County\Geocode\gis_geocode.csv';
%let gis_geocode_maz = 'M:\Data\OnBoard\Data and Reports\Sonoma County\Geocode\gis_geocode_maz.csv';
%let output_directory = M:\Data\OnBoard\Data and Reports\Sonoma County\_working;
run;
...
data catiA; set OnBoard.rawSonomaCati;
   orig_purp = "                         ";
   dest_purp = "                         ";
   ...
   if q1 = 10 then orig_purp = "other maintenance";
   if q1 = 11 then orig_purp = "eat out";
   if q1 = 12 then orig_purp = "escorting";
   if q1 = 13 then orig_purp = "other maintenance";
   ...
   if q2 = 11 then dest_purp = "eat out";
   if q2 = 12 then dest_purp = "escorting";
   if q2 = 13 then dest_purp = "other maintenance";
...
data catiA; set catiA;
   ...
   if q10 = 1 and q11 = 1 and q12 = 11 then orig_purp = "eat out";
   if q10 = 1 and q11 = 1 and q12 = 12 then orig_purp = "escorting";
   if q10 = 1 and q11 = 1 and q12 = 13 then orig_purp = "other maintenance";
   ...
   if q10 = 1 and q11 = 2 and q12 = 6  and q227>97 then dest_purp = "grade school";
   ...
   if q10 = 1 and q11 = 2 and q12 = 11 then dest_purp = "eat out";
   if q10 = 1 and q11 = 2 and q12 = 12 then dest_purp = "escorting";
   if q10 = 1 and q11 = 2 and q12 = 13 then dest_purp = "other maintenance";
...
* Move to the ones that require more faith or have odd 211/212/213 combinations;
...
data OnBoard.son_cati_purp; set catiD;
...
data gisA;  set OnBoard.rawSonomaGis;
   rename surveyid = id;
   rename idcode   = qcode;
data catiA; set OnBoard.son_cati_purp; keep id q10 q11;
data geoA;  set input;
...
data geoD; set geoC;
  ...
  * Correct for updated origin or destination;
  ...
  if q = 207 then workMAZ   = maz1454;
  if q = 209 then schoolMAZ = maz1454;
  if q = 210 then homeMAZ   = maz1454;
...
data OnBoard.son_key_loc_taz; set geoE; drop _TYPE_ _FREQ_;
run;

* Set the home and work locations if they are an origin or a destionation;
data catiA; set OnBoard.son_cati_purp; keep id orig_purp dest_purp;
data gisA; set OnBoard.son_key_loc_taz;
...
data OnBoard.son_key_loc_taz; set gisC; drop orig_purp dest_purp;
run;
...
data catiA; set OnBoard.son_cati_purp;
...
data OnBoard.son_cati_purp_asuff; set catiB;
...
%MACRO TM_MODE(LABEL,MODE_Q,AC_SEL_Q,AC_Q,MUNI_Q,TRANSFER);
   ...
   * AC Transit;
   ...
   if &MODE_Q = 1 and &AC_SEL_Q = 2 and (&AC_Q < 61 or &AC_Q > 94) then &LABEL = 'local bus';
   if &MODE_Q = 1 and &AC_SEL_Q = 2 and &AC_Q > 62 then &LABEL = 'express bus';
...
* Set the access mode;
data catiA; set OnBoard.son_cati_purp_asuff;
...
proc freq data = catiE; tables _27 boardings boardings*_27;
run;

data OnBoard.son_cati_purp_asuff_path; set catiE;
...
data catiA; set OnBoard.son_cati_purp_asuff_path; 
   ...
   fare_medium = 'Missing                             ';
   if q218 = 1  then fare_medium = 'cash';
   if q218 = 2  then fare_medium = 'pass (monthly)';
   if q218 = 3  then fare_medium = 'pass (31-day)';
   if q218 = 4  then fare_medium = 'pass (super)';
   if q218 = 5  then fare_medium = 'pass (20-ride fastpass)';
   if q218 = 6  then fare_medium = 'ticket (paratransit)';
   if q218 = 7  then fare_medium = 'other';
   ...
   * CATI language (phone interview language);
   ...
   if _01 = 1 then interview_language = 'English';
   if _01 = 2 then interview_language = 'Spanish';
   if _01 = 3 then interview_language = 'Cantonese Chinese';
   if _01 = 4 then interview_language = 'Mandarin Chinese';
...
data OnBoard.son_cati_purp_asuff_path_sd; set catiA;
...
data catiA; set OnBoard.son_cati_purp_asuff_path_sd;
  ...
  * Convert the character times to time variables;
  ...
  q216_time = input(q216,time12.);
   ...
   if q215 = 1 and HOUR(q214_time) = 12 then depart_hour = 0;
...
data catiB; set catiA; keep id weight route daypart orig_purp dest_purp tour_purp autoSuff access_mode survey_mode egress_mode
                            ...
                            interview_language depart_hour return_hour weight;
...
data OnBoard.son_cati_ready; set catiB;
run;

* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;
* Step 8: Extract data from info file, build a combined data set, then segment weekend and weekday;
* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~;

data infoA; set OnBoard.rawSonomaInfo;
   ...
   if destination_type_code = 1  then dest_purp_field = "work";
   if destination_type_code = 2  then dest_purp_field = "work-related";
   if destination_type_code = 3  then dest_purp_field = "home";
   if destination_type_code = 4  then dest_purp_field = "social recreation";
   if destination_type_code = 5  then dest_purp_field = "shopping";
   if destination_type_code = 6  then dest_purp_field = "grade or high school";
   if destination_type_code = 7  then dest_purp_field = "university";
   if destination_type_code = 8  then dest_purp_field = "other maintenance";
   if destination_type_code = 9  then dest_purp_field = "other maintenance";
   if destination_type_code = 10 then dest_purp_field = "missing";
   if destination_type_code = 14 then dest_purp_field = "missing";
...
data OnBoard.son_info_ready; set infoC; keep id route direction field_language orig_purp_field dest_purp_field survey_boarding_x survey_boarding_y survey_alighting_x survey_alighting_y first_boarding_x first_boarding_y last_alighting_x last_alighting_y;
...
data dowA; set OnBoard.rawSonomaDow; keep survey_id day_of_the_week;
   rename survey_id = id;

data OnBoard.son_dow_ready; set dowA;
   label day_of_week = "Day of week of field survey";
run;


* Merge the data sets;
data catiA; set OnBoard.son_cati_ready;
data locA;  set OnBoard.son_key_loc_taz;
data infoA; set OnBoard.son_info_ready;
data dowA;  set OnBoard.son_dow_ready;
...
data comboC; set comboB;
   weekpart       = 'WEEKDAY';
   operator       = 'Sonoma County                                     ';
*                   '12345678901234567890123456789012345678901234567890';
   field_start    = MDY(4,17,2012); 
   field_end      = MDY(4,20,2012);

data OnBoard.son_ready; set comboC;
run;
