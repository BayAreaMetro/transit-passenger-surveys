# Create TPS file with distances appended.r
...
survey_in <- file.path(survey_dir,"TPS_Model_Version_PopulationSim_Weights_lat_lon_2021-12-14.Rdata")
load (survey_in)
...
save(TPS_distance,file = file.path(survey_dir,"TPS_Model_Version_PopulationSim_Weights_Distances_2021-12-14.Rdata"))
