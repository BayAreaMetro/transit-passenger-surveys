...
#### Status
seems to be working, though the optimization currently takes over 50 hours

#### TODO
1.  explore different importance weighting schemes to find one i like 
...
F_TARGETS <- paste(input_dir, "multi-criteria-expansion/observed-target-counts-two.Rdata", sep = "")
F_DEFNS   <- paste(input_dir, "multi-criteria-expansion/observed-target-definitions-two.Rdata", sep = "")
