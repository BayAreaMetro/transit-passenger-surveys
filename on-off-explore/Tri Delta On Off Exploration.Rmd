...
# START HERE: go through board, then alight, then board + alight
# then try a linear programming approach, where you try to satisfy multiple criteria (starting with two)

# Step 4: join non-missing routes, from Step 1, and direction, and time-of-day, and boarding location
