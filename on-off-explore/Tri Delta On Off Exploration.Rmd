...
obs_targets_vector <- obs_targets_df$onoff_count

# Step 2: build the importance weights vector (all 1s for now)
importance_weights_vector <- obs_targets_vector * 0 + 1

# Step 3: build the incidence matrix (summarised tablet rows * 88)

# START HERE: need to cast the targets df, so you have an incidence with the route, direction, and time, then need to summarise the tablet by these dimensions, then need to join the two
