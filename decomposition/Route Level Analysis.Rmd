...
boardings_df <- working_df %>%
  ...
  mutate(survey_boardings = ifelse(is.na(survey_boardings), 0, survey_boardings)) %>%
  select(operator, route, route_full, weekpart, survey_name, survey_year, survey_boardings)
