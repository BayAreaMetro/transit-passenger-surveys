...
F_CHAMP_FLOWS    = ""
F_RAIL_DMY_APC   = "M:/Data/Transit/Muni APC Through Time/_placeholder/dummy-rail-database.csv"
...
rail_counts <- read.table(file = F_RAIL_DMY_APC, header = TRUE, sep = ",", stringsAsFactors = FALSE)
...
1.  Join the APC data with the apc segment database to get the segment letter for each stop.
1.  Join the CHAMP data to the champ segment database to get the boarding and alighting segment letter
...
1.  Automate the creation of the rail counts/marginals
1.  Build out the crosswalks per the actual segments
