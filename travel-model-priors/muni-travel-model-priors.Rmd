...
# EVEN MORE DEBUG
```{r why-does-balance-fail}
# check champ for missing segments
# missing <- champ_df %>%
#   filter(!(is.na(board_segment) & is.na(alight_segment))) %>%
#   filter(is.na(board_segment) | is.na(alight_segment))
# 
# table(missing$alight_stop_sequence, missing$apc_route)
#   
