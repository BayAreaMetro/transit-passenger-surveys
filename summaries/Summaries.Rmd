...
for (std_name in std_names) {
  if(!(std_name %in% legacy_names)) {
    ...
    if (typeof(survey.standard[,std_name])=="character") {
      survey.legacy[,std_name] <- as.character(survey.legacy[,std_name])
    } else if (typeof(survey.standar[,std_name]=="double")) {
...
data.ready <- data.ready[,c(which(colnames(data.ready)!="survey_time"),
                            which(colnames(data.ready)=="survey_time"))]
