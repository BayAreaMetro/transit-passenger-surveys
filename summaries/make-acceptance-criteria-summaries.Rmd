...
output_filename <- paste0(box_dir, "Survey_Database_122717/acceptance-criteria-summaries-year-2015.csv")
```

# Parameters
```{r parameters}
time_period_dict_df <- tibble(day_part = c("EARLY AM", "AM PEAK", "MIDDAY", "PM PEAK", "EVENING", "NIGHT"),
